...
export class AuthController {
  ...
  async googleAuthRedirect(@Req() req: any, @Res() res: Response) {
    ...
    const redirectUrl = `http://localhost:${clientPort}?token=${responseUser.access_token}?isPremium=${updatedUser.isPremium}?isAdmin=GVTYYVDF0cFVNJiZ1eu2?isHr=GVTYYVDF0cFVNJiZ1eu2?isAuth=FVCHbxMAxePUFQG0tcDV`;
